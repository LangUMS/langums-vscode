...
exports.Grp = Grp; // Mostly just a id -> key -> Grp mapping which shares
...
class GrpGroup {
  ...
  unit(unitId, readCb) {
    ...
    return _asyncToGenerator(function* () {
      return _this._getGrp(_this._units[unitId], readCb);
    })();
  }

  sprite(spriteId, readCb) {
    var _this2 = this;

    return _asyncToGenerator(function* () {
      return _this2._getGrp(_this2._sprites[spriteId], readCb);
    })();
  }
  ...
  _getGrp(key, readCb) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const value = _this3._grps.get(key);
      if (value !== undefined) {
        return value;
      } else {
        const grp = new Grp((yield readCb('unit/' + key)));
        _this3._grps.set(key, grp);
        return grp;
      }
    })();
  }
}
exports.default = GrpGroup;